...
export default function VestidosPage() {
  ...
  return (
    <main>
      ...
      {/* Hero Banner */}
      <section style={{
        backgroundImage: 'url(https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=1920)',
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <h1 style={{ fontSize: '42px', color: 'white', marginBottom: '12px' }}>VESTIDOS</h1>
