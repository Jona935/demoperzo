...
export default function AccesoriosPage() {
  ...
  return (
    <main>
      ...
      {/* Hero Banner */}
      <section style={{
        backgroundImage: 'url(https://images.unsplash.com/photo-1611923134239-b9be5816e23c?w=1920)',
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <h1 style={{ fontSize: '42px', color: 'white', marginBottom: '12px' }}>ACCESORIOS</h1>
          <p style={{ color: 'rgba(255,255,255,0.9)', maxWidth: '500px', margin: '0 auto' }}>
            El toque final perfecto para tu outfit
          </p>
        </div>
      </section>
